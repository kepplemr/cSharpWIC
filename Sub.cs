...
namespace csWIC
{
    ...
    {
        public Sub(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>SUB execute function</summary>
        ...
        /// <remarks>Pops two values off of the stack, subtracts the first from the second, pushes result.</remarks>
