...
namespace csWIC
{
    ...
    {
        public And(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>ADD execute function</summary>
        ...
        /// <remarks>Pops two values off of the stack. If both are non-zero, push a '1' on the stack.</remarks>
