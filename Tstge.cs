...
namespace csWIC
{
    class Tstge : Instruction
    {
        public Tstge(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>TSTGE execute function</summary>
        ...
        /// <remarks>Pops top value off the stack, compares to zero. Pushes '1' if greater than or equal zero, '0' otherwise.</remarks>
