...
namespace csWIC
{
    class Tsteq : Instruction
    {
        public Tsteq(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>TSTEQ execute function</summary>
        ...
        /// <remarks>Pops top value off the stack, compares to zero. Pushes '1' if zero, '0' otherwise.</remarks>
