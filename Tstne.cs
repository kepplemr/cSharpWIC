...
namespace csWIC
{
    class Tstne : Instruction
    {
        public Tstne(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>TSTNE execute function</summary>
        ...
        /// <remarks>Pops top value off the stack, compares to zero. Pushes '1' if not zero, '0' otherwise.</remarks>
