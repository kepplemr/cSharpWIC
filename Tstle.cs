...
namespace csWIC
{
    class Tstle : Instruction
    {
        public Tstle(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>TSTLE execute function</summary>
        ...
        /// <remarks>Pops top value off the stack, compares to zero. Pushes '1' if less than or equal to zero, '0' otherwise.</remarks>
