...
namespace csWIC
{
    ...
    {
        public Mod(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>MOD execute function</summary>
        ...
        /// <remarks>Pops two values off of the stack, mods them, pushes result.</remarks>
