...
namespace csWIC
{
    class Tstlt : Instruction
    {
        public Tstlt(string operation, string operand)
            : base(operation, operand) { }

        /// <summary>TSTLT execute function</summary>
        ...
        /// <remarks>Pops top value off the stack, compares to zero. Pushes '1' if less than zero, '0' otherwise.</remarks>
